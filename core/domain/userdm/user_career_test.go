...
func TestNewUserCareer(t *testing.T) {
	...
	t.Run("UserCareerIDが空", func(t *testing.T) {
		...
		if err == nil {
			t.Errorf("failed to NewUserCareerID empty validation: %v", err)
		}
	})
	...
	t.Run("Fromが空", func(t *testing.T) {
		...
		if err == nil {
			t.Errorf("failed to From empty validation: %v", err)
		}
	})
	...
	t.Run("Fromが1969年以前", func(t *testing.T) {
		...
		if err == nil {
			t.Errorf("failed to From datecheck validation: %v", err)
		}
	})
	...
	t.Run("Toが空", func(t *testing.T) {
		...
		if err == nil {
			t.Errorf("failed to To empty validation: %v", err)
		}
	})
	...
	t.Run("FromがTo以前", func(t *testing.T) {
		...
		if err == nil {
			t.Errorf("failed to From and To datecheck validation: %v", err)
		}
	})
	...
	t.Run("Detailが空", func(t *testing.T) {
		...
		if err == nil {
			t.Errorf("failed to Detail empty validation: %v", err)
		}
	})
	...
	t.Run("Detailが最大文字数超過", func(t *testing.T) {
		...
		if err == nil {
			t.Errorf("failed to Detail maxlength validation: %v", err)
		}
	})
}
